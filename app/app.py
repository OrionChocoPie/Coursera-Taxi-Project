...
pred_data = predicted_data[predicted_data["pred_number"] == "1"].drop(
    "pred_number", axis=1
)
...
def build_banner():
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.H3("Прогноз вызовов в такси", style={"text-align": "center"}),
                    html.H5("Нью-Йорк", style={"text-align": "center"}),
                ],
